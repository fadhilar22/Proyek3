...
<html lang="en">
    ...
    <body>
        ...
        <div>
            ...
            <img class="img-fluid w-100" src="assets/img/content11.jpg">
            ...
            <div class="box1">
                ...
                <!-- isi / konten -->
                <div class="konten">
                For a smile adalah sebuah program yang mengajak kalian untuk berbagi kepada sesama. disini kita bisa berbagi makanan,stationary,pakaian,dan uang.
                </div>
            </div>
        </div>
                <!-- konten gambar -->
                <div class="container mb-5">
                    <div class="row">
                        <!-- konten gambar terdiri dari 4 buah gambar -->
                        <div class="col">
                            <img src="assets/img/forasmile_content1.png" class="img-fluid border rounded">
                        </div>
                        <div class="col">
                            <img src="assets/img/forasmile_content2.png" class="img-fluid border rounded">
                        </div>
                        <div class="col">
                            <img src="assets/img/forasmile_content3.png" class="img-fluid border rounded">
                        </div>
                    </div>
                </div>
        <!-- bagian footer -->
